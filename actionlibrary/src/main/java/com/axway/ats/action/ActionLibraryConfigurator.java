...
public class ActionLibraryConfigurator extends AbstractConfigurator {
    ...
    @PublicAtsApi
    public void setFileSnapshotCheckModificationTime(
                                                      boolean checkModificationTime ) {

        setTempProperty( FILE_SNAPSHOT_CHECK_MODIFICATION_TIME, Boolean.toString( checkModificationTime ) );
    }
    ...
    @PublicAtsApi
    public void setFileSnapshotCheckFileSize(
                                              boolean checkSize ) {
    ...
    @PublicAtsApi
    public void setFileSnapshotCheckFileMd5(
                                             boolean checkMd5 ) {
    ...
    @PublicAtsApi
    public void setFileSnapshotCheckFilePermissions(
    ...
    @PublicAtsApi
    public void setFileSnapshotSupportHiddenFiles(
