...
import com.axway.ats.action.rest.RestHeader;
...
import com.axway.ats.examples.basic.http.testbeans.PersonPojo;
import com.axway.ats.examples.basic.http.testbeans.PersonXmlBean;

/**
 * Here we show different examples with the RestClient class
 *
 * Rest operations are introduced at: 
 *      https://axway.github.io/ats-framework/REST-Operations.html
 *
 ...
 * as the tests in HttpOperations class.
 */
public class RestOperationTests extends HttpBaseClass {
    ...
    public void post_usingFormParameters() {
        ...
        RestForm formParameters = new RestForm().addParameter("firstName", "Chuck")
    ...
    public void put_usingFormParameters() {
        ...
        RestResponse response = client.putForm(new RestForm().addParameter("firstName", "Chuck")
                                                             .addParameter("lastName", "Norris")
                                                             .addParameter("age", "71"));
        assertEquals(response.getStatusCode(), 200);
