...
public class DbChannel {
    ...
    /**
     * When true - info is dumped about the usage of the events queue. It is
     * targeted as a debug tool when cannot send the events to the DB fast
     * enough.
     */
     ...
     * probably different from zero on the Agent side (where PassiveDbAppender is used)
     */
