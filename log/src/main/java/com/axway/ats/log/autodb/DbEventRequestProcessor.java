...
public class DbEventRequestProcessor implements EventRequestProcessor {
    ...
    private void updateTestcase( UpdateTestcaseEvent updateTestcaseEvent, String executorId,
                                 long timestamp ) throws LoggingException {
    ...
    private void leaveTestCase(String executorId ) {
        ...
        if( "main".equals( threadId ) ) {
            ...
            throw new LoggingIsOverException( "Logging is over for <" + executorId + ">. Loging thread "
    ...
    private void constructUpdateRunEvent() {
        ...
        try {
            ...
            */
            new AtsConsoleLogger(getClass()).error("Unable to update run with ID '" + _startRunState.getRunId() + "'", e);
        }
