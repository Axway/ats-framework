...
public class Test_ConnectionPool extends BaseTest {
    ...
    public static void beforeClass() {
        ...
        System.setProperty(DbKeys.CONNECTION_RETRY_COUNT, "2");
        System.setProperty(DbKeys.CONNECTION_RETRY_TIMEOUT, "1"); // interval between invocations
    }
    ...
    public static void afterClass() {
        ...
        System.setProperty(DbKeys.CONNECTION_RETRY_COUNT, "2");
        System.setProperty(DbKeys.CONNECTION_RETRY_TIMEOUT, "4"); // interval between invocations
    }
