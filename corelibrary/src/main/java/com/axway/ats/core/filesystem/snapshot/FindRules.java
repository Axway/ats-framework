...
public class FindRules implements Serializable {
    ...
    static final int          SEARCH_FILENAME_AS_REGEX     = 0x01;

    static final int          SKIP_FILE_PATH               = SEARCH_FILENAME_AS_REGEX << 1;
    static final int          SKIP_FILE_SIZE               = SKIP_FILE_PATH << 1;
    static final int          SKIP_FILE_MODIFICATION_TIME  = SKIP_FILE_SIZE << 1;
    static final int          SKIP_FILE_MD5_SUM            = SKIP_FILE_MODIFICATION_TIME << 1;
    static final int          SKIP_FILE_PERMISSIONS        = SKIP_FILE_MD5_SUM << 1;

    static final int          CHECK_FILE_SIZE              = SKIP_FILE_PERMISSIONS << 1;
    static final int          CHECK_FILE_MODIFICATION_TIME = CHECK_FILE_SIZE << 1;
    static final int          CHECK_FILE_MD5_SUM           = CHECK_FILE_MODIFICATION_TIME << 1;
    static final int          CHECK_FILE_PERMISSIONS       = CHECK_FILE_MD5_SUM << 1;
    static final int          CHECK_FILE_ALL_ATTRIBUTES    = CHECK_FILE_SIZE | CHECK_FILE_MODIFICATION_TIME
