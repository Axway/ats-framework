...
public class ExecutorUtils {
    ...
    private final static Logger LOG = Logger.getLogger(ExecutorUtils.class );
            ...
            if( userRandomToken == null ) {
                ...
                if( uuidFile.exists() ) {
                    ...
                    try {
                        ...
                        throw new FileSystemOperationException( "Unable to extract random user token from file '"
                                                                + uuidFile.getPath() + "'", e );
                    }
