...
/**
 * This class is used whenever a call to the agent must be performed, except then action is invoked. That is done via RemoteExecutor
 * */
public class HttpClient {
     ...
     * Use this method when a request to the Agent does not come from an Action method invocation.
