...
public class InternalProcessOperations {
    ...
    @ActionRequestInfo( requestUrl = "processes/executors/kill/all", requestMethod = "POST")
    ...
    @ActionRequestInfo( requestUrl = "processes/executors/envvar", requestMethod = "DELETE")
    ...
    @ActionRequestInfo( requestUrl = "processes/executors/envvar", requestMethod = "GET")
