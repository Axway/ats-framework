...
public class OshiDiskUsage implements IDiskUsage {

    private String      devName;
    private HWDiskStore internalImplementation;

    public OshiDiskUsage( HWDiskStore diskStore, String devName ) {

        this.devName = devName;
        this.internalImplementation = diskStore;
