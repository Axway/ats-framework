 ...
 * host, such as ATS_UID, RestClient object and AgentIP
 */
public class RestHelper {
    ...
    public RestResponse post(
        ...
        try {
            ...
            // disconnect after POST operation is complete, regardless of the status code of the response
